	...
	<view class="view">
		<view class="wrap">
			<view class="look">
				...
				<view class="line" v-for="(vote,index) in voteArr">
					<view class="rank">
						<text>{{index+1}}</text>
					</view>
					<view class="staff">
						<text>{{vote.by_voters}}</text>
					</view>
					<view class="votes">
						<text>{{vote.by_voters__count}}票</text>
					</view>
				</view>
			</view>
		</view>
...
<style>
	...
	.view{
		width: 100%;
		height: 60%;
		background-image: url(../../static/vote/vote20_bg.png);
