<template>
	<view class="content" style="width: 100%;">
		...
		<view v-else>
			<xw-empty :isShow="isEmpty" img="http://47.94.106.106:8888/group1/M00/5D/28/rBHxiGGttGKAF3e_AAGO0pJ-sIs6197168" path="" btnText="" text="您还没有评价内容" textColor="#C0C4CC"></xw-empty>
		</view>
	</view>
</template>
