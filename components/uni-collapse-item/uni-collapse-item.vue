	...
	<view :class="{ 'uni-collapse-cell--disabled': disabled,'uni-collapse-cell--notdisabled': !disabled, 'uni-collapse-cell--open': isOpen,'uni-collapse-cell--hide':!isOpen }"
	 class="uni-collapse-cell">
		<view class="uni-collapse-cell__title" @click="onClick">
			...
			<image v-if="thumb1" style="margin-left: 40upx;" :src="thumb1" class="uni-collapse-cell__title-img" />
			<text class="uni-collapse-cell__title-text">{{ title1 }}</text>
			<image v-if="thumb2" style="margin-left: 40upx;" :src="thumb2" class="uni-collapse-cell__title-img" />
			<text class="uni-collapse-cell__title-text">{{ title2 }}</text>
			<!-- #ifdef MP-ALIPAY -->
