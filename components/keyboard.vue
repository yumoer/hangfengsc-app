	...
	<view class="keyborad" :style="{transform:show_key?'translateY(0)':'translateY(100%)'}">
		<view class="key_main">
			<view class="main_title">
				<image src="http://47.94.106.106:8888/group1/M00/5D/BF/rBHxiGHEQEyAXyfbAAABVfIaj8g4221950" mode="aspectFill" @tap="hideFun"></image>
				<text>请输入支付密码</text>
			</view>
			<view class="main_content">
				...
				<view class="main_forget" @tap="forgetFun">设置支付密码</view>
			</view>
			<view class="main_keyboard">
				...
				<view class="key_del" @tap="delNumFun">
					<image src="http://47.94.106.106:8888/group1/M00/5D/BF/rBHxiGHEQEyAQAZnAAAB-CBQYV47927490" mode="aspectFill"></image>
				</view>
			</view>
		</view>
	</view>
